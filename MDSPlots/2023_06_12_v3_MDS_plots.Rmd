...
**Purpose**
This is the third version of MDS_Plots.Rmd file with the goal of creating different MDS plots. The plots we will be creating are;

1) Tumor adjacent plot colored by male and female 
2) Tumor plot colored by male and female 
3) Tumor adjacent plot colored by HBV
4) Tumor plot colored by HCV 
