...
pdf("~/Desktop/Research Projects/Liver Cancer Project/Figures/MDS Plots/Version 2 Sex Stratified MDS Plot top 25 genes.pdf")
...
pdf("~/Desktop/Research Projects/Liver Cancer Project/Figures/MDS Plots/Test Version Sex Stratified MDS Plot top 25 genes.pdf", width=75, height=75)
...
pdf("~/Desktop/Research Projects/Liver Cancer Project/Figures/MDS Plots/ Sample coloring RK106 Sex Stratified MDS Plot top 25 genes.pdf", width=50, height=50)
mds <- plotMDS(vCorrectLibtype, top = 25, labels= colnames(vCorrectLibtype), ndim = 10, dim.plot = c(1,2), plot=TRUE, cex=2,
               pch=ifelse(v$targets$viral %in% c("HBV"), 17,
                          ifelse(v$targets$viral %in% c("HCV"), 15,
                                 ifelse(v$targets$viral %in% c("both"), 16,  3))),
...
pdf("~/Desktop/Research Projects/Liver Cancer Project/Figures/MDS Plots/ Sample coloring RK113 Sex Stratified MDS Plot top 25 genes.pdf", width=50, height=50)
mds <- plotMDS(vCorrectLibtype, top = 25, labels= colnames(vCorrectLibtype), ndim = 10, dim.plot = c(1,2), plot=TRUE, cex=2,
               pch=ifelse(v$targets$viral %in% c("HBV"), 17,
                          ifelse(v$targets$viral %in% c("HCV"), 15,
                                 ifelse(v$targets$viral %in% c("both"), 16,  3))),
...
pdf("~/Desktop/Research Projects/Liver Cancer Project/Figures/MDS Plots/ Sample coloring RK169 Sex Stratified MDS Plot top 25 genes.pdf", width=50, height=50)
mds <- plotMDS(vCorrectLibtype, top = 25, labels= colnames(vCorrectLibtype), ndim = 10, dim.plot = c(1,2), plot=TRUE, cex=2,
               pch=ifelse(v$targets$viral %in% c("HBV"), 17,
                          ifelse(v$targets$viral %in% c("HCV"), 15,
                                 ifelse(v$targets$viral %in% c("both"), 16,  3))),
...
pdf("~/Desktop/Research Projects/Liver Cancer Project/Figures/MDS Plots/ Sample coloring 096 Sex Stratified MDS Plot top 25 genes.pdf", width=50, height=50)
mds <- plotMDS(vCorrectLibtype, top = 25, labels= colnames(vCorrectLibtype), ndim = 10, dim.plot = c(1,2), plot=TRUE, cex=2,
               pch=ifelse(v$targets$viral %in% c("HBV"), 17,
                          ifelse(v$targets$viral %in% c("HCV"), 15,
                                 ifelse(v$targets$viral %in% c("both"), 16,  3))),
...
**Conclusion**
Four samples and their paired samples were investigated in this file. Sample RK-135-tumor-XX is a female tumor sample that was located in the male tumor sample cluster was found to have no paired adjacent sample based on looking through the "metadata" variable. This sample may end up being removed from the sample data based on this information. 
...
Sample RK169-adjacent-XY is a male adjacent sample located in the male tumor cluster. Its paired sample is a male tumor samples located in the male adjacent cluster. Based on this information, these samples possibly have mislabed lesion type, however, further investigation is needed. 
