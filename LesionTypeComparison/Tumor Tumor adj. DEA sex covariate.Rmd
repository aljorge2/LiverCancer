---
title: "Tumor Tumor adj. Sex covariate"
...
Author: Annika Jorgensen  
Date: 01/17/2023 
Purpose: The Purpose of this file is to do a DEA with the ICGC liver cancer data on all tumor tumor adjacent data with sex added as a covariate. The purpose is to make sure that sex is accounted for sex as a potential influence of the expressed genes.
