...
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/vCorrectLibtype.csv")

pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/MDSPlots/Library Type Correction.pdf")
...
write.csv(DDX3Y_expression,"~/Desktop/ResearchProjects/LiverCancer/Figures/Violinplots/DDX3Y_expression_values_iteration_1.csv" )
...
write.csv(DDX3Y_expression,"~/Desktop/ResearchProjects/LiverCancer/Figures/Violinplots/DDX3Y_expression_values_iteration_2.csv" )
...
#XISTp<-ggplot(Violin_data, aes(x=Gender, y=Expression)) + geom_violin(aes(fill=Gender), trim = FALSE) + geom_point(position= position_jitter(seed=1, width = 0.1))+ labs(x=NULL,y="log(RNA Expression) (TPM)")+ theme_bw()+theme(text = element_text(size=13,face="bold"))
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Violinplots/DDX3Y_violin_expression_ICGC_data.pdf", width=12, height=12)
DDX3Yp
dev.off()
```
Plotting for KDM5C
...
#XISTp<-ggplot(Violin_data, aes(x=Gender, y=Expression)) + geom_violin(aes(fill=Gender), trim = FALSE) + geom_point(position= position_jitter(seed=1, width = 0.1))+ labs(x=NULL,y="log(RNA Expression) (TPM)")+ theme_bw()+theme(text = element_text(size=13,face="bold"))
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Violinplots/UTY_violin_expression_ICGC_data.pdf", width=12, height=12)
UTYp
dev.off()
...
#XISTp<-ggplot(Violin_data, aes(x=Gender, y=Expression)) + geom_violin(aes(fill=Gender), trim = FALSE) + geom_point(position= position_jitter(seed=1, width = 0.1))+ labs(x=NULL,y="log(RNA Expression) (TPM)")+ theme_bw()+theme(text = element_text(size=13,face="bold"))
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Violinplots/USP9Y_violin_expression_ICGC_data.pdf", width=12, height=12)
USP9Yp
dev.off()
...
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Barplots/RK106_T_XX_gene_expression_barplots.pdf", width=12, height=12)
...
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Barplots/RK113_A_XY_gene_expression_barplots.pdf", width=12, height=12)
barplot(height=RK113_A_XY_expression,beside=T, xlim=c(-2,2.5),names.arg = c("XIST","DDX3Y","UTY","USP9Y"),horiz=T,las=1, font.axis=4, cex.axis=3)
dev.off()
```
...
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Barplots/RK169_A_XY_gene_expression_barplots.pdf", width=12, height=12)
barplot(height=RK169_A_XY_expression,beside=T, xlim=c(-2,2.5),names.arg = c("XIST","DDX3Y","UTY","USP9Y"),horiz=T,las=1, font.axis=4, cex.axis=3)
dev.off()
```
...
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Barplots/RK106_A_XX_gene_expression_barplots.pdf", width=12, height=12)
barplot(height=RK106_A_XX_expression,beside=T, xlim=c(-2,2.5),names.arg = c("XIST","DDX3Y","UTY","USP9Y"),horiz=T,las=1, font.axis=4, cex.axis=3)
dev.off()
```
...
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Barplots/RK113_T_XY_gene_expression_barplots.pdf", width=12, height=12)
barplot(height=RK113_T_XY_expression,beside=T, xlim=c(-2,2.5),names.arg = c("XIST","DDX3Y","UTY","USP9Y"),horiz=T,las=1, font.axis=4, cex.axis=3)
dev.off()
```
...
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Barplots/RK169_T_XY_gene_expression_barplots.pdf", width=12, height=12)
barplot(height=RK169_T_XY_expression,beside=T, xlim=c(-2,2.5),names.arg = c("XIST","DDX3Y","UTY","USP9Y"),horiz=T,las=1, font.axis=4, cex.axis=3)
dev.off()
```
...
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Barplots/RK135_T_XX_gene_expression_barplots.pdf", width=12, height=12)
barplot(height=RK135_T_XX_expression,beside=T, xlim=c(-2,2.5),names.arg = c("XIST","DDX3Y","UTY","USP9Y"),horiz=T,las=1, font.axis=4, cex.axis=3)
dev.off()
```
...
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Barplots/RK105_T_XY_gene_expression_barplots.pdf", width=12, height=12)
...
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Barplots/RK105_A_XY_gene_expression_barplots.pdf", width=12, height=12)
...
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Barplots/RK065_T_XX_gene_expression_barplots.pdf", width=12, height=12)
...
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Barplots/RK065_A_XX_gene_expression_barplots.pdf", width=12, height=12)
...
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Barplots/RK116_T_XX_gene_expression_barplots.pdf", width=12, height=12)
...
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Barplots/RK116_A_XX_gene_expression_barplots.pdf", width=12, height=12)
...
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Barplots/RK066_T_XX_gene_expression_barplots.pdf", width=12, height=12)
...
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Barplots/RK066_A_XX_gene_expression_barplots.pdf", width=12, height=12)
...
pdf("~/Desktop/ResearchProjects/LiverCancer/Figures/Barplots/RK096_T_XY_gene_expression_barplots.pdf", width=12, height=12)
