...
tumor_tumor_adjacent <- read.csv("~/Desktop/Research Projects/Liver Cancer Project/Pathway Analysis Results/Tumor Tumor-adjacent results.csv")

male_all <- read.csv("~/Desktop/Research Projects/Liver Cancer Project/Pathway Analysis Results/Male_results.csv")

female_all <- read.csv("~/Desktop/Research Projects/Liver Cancer Project/Pathway Analysis Results/Female_results.csv")
...
pdf("~/Desktop/Research Projects/Liver Cancer Project/Pathway Analysis Results/upsetplot_sex_stratified.pdf", width = 12, height = 12)
...
write.csv(male_shared$Pathway.name, "~/Desktop/Research Projects/Liver Cancer Project/Pathway Analysis Results/Shared Pathways.csv")
```
...
HBV_all <- read.csv("~/Desktop/Research Projects/Liver Cancer Project/Pathway Analysis Results/HBV_results.csv")
HCV_all <- read.csv("~/Desktop/Research Projects/Liver Cancer Project/Pathway Analysis Results/HCV_results.csv")
...
pdf("~/Desktop/Research Projects/Liver Cancer Project/Pathway Analysis Results/upsetplot_etiology_stratified.pdf", width = 12, height = 12)
 upset(fromList(input), order.by= "freq", nsets=3, line.size=1.5, text.scale= c(5,5,4.5,2.0,5,5))
 dev.off()
```
...
write.csv(shared_etiology, "~/Desktop/Research Projects/Liver Cancer Project/Pathway Analysis Results/all_shared_etiology_pathways.csv")
```
...
HBV_covariate <- read.csv("~/Desktop/Research Projects/Liver Cancer Project/Pathway Analysis Results/HBV_covariate_results.csv")
HCV_covariate <- read.csv("~/Desktop/Research Projects/Liver Cancer Project/Pathway Analysis Results/HBV_covariate_results.csv")

sex_covariate_all <- read.csv("~/Desktop/Research Projects/Liver Cancer Project/Pathway Analysis Results/tumor tumor adjacent sex covariate.csv")
```
...
pdf("~/Desktop/Research Projects/Liver Cancer Project/Pathway Analysis Results/Etiology Stratified with Sex as a Covariate Upset Plot.pdf", width = 12, height = 12)
...
write.csv(shared_etiology, "~/Desktop/Research Projects/Liver Cancer Project/Pathway Analysis Results/covariate_shared_etiology_pathways.csv")
```
