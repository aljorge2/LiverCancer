...
for (gene in keys(h)) {
  ...
  pdf(paste("~/Desktop/ResearchProjects/LiverCancerProject/DEA_removed_samples/newFigures/y_linked_gene_tumor_expression/",gene,"_tumor_expression_data.pdf",sep=""), width=12, height=12)
  ...
  pdf(paste("~/Desktop/ResearchProjects/LiverCancerProject/DEA_removed_samples/newFigures/y_linked_gene_adjacent_expression/",gene,"_tumor_adjacent_expression_data.pdf",sep=""), width=12, height=12)
...
#Creates a box plot of Xist gene expression data of all tumor samples 
  pdf("~/Desktop/ResearchProjects/LiverCancerProject/DEA_removed_samples/newFigures/x_degenerate_tumor_gene_expression/XIST_tumor_expression_data.pdf", width=12, height=12)
  ...
  dev.off() 
   ...
   pdf("~/Desktop/ResearchProjects/LiverCancerProject/DEA_removed_samples/newFigures/x_degenerate_tumor_gene_expression/XIST_tumor_expression_500Axis_data.pdf", width=12, height=12)
  print(ggplot(XistTumor, aes(x=reorder(Names,SexViralNumeric),y= Expression,fill=SexViralNumeric)) + geom_bar(stat="identity", colour="black") +theme(axis.text.x = element_text(angle = 90, vjust = 0.75,hjust = 0.75, size=8)) +  scale_x_discrete(guide = guide_axis(n.dodge = 2)) + coord_cartesian(ylim=c(0,500))+ xlab("Tumor Samples Expression data") + labs(title="XIST Tumor  Samples Expression Data"))
  dev.off() 
  
  
   pdf("~/Desktop/ResearchProjects/LiverCancerProject/DEA_removed_samples/newFigures/x_degenerate_adjacent_gene_expression/XIST_tumor_adjacent_expression_data.pdf", width=12, height=12)
  ...
  dev.off() 
   ...
   #Creates a box plot of y-linked gene expression data of all tumor adjacent samples
  pdf("~/Desktop/ResearchProjects/LiverCancerProject/DEA_removed_samples/newFigures/x_degenerate_adjacent_gene_expression/XIST_tumor_adjacent_expression_500Axis_data.pdf", width=12, height=12)
...
for (gene in keys(h)) {
  ...
  pdf(paste("~/Desktop/ResearchProjects/LiverCancerProject/DEA_removed_samples/newFigures/x_degenerate_tumor_gene_expression/",gene,"_tumor_expression_data.pdf",sep=""), width=12, height=12)
  ...
  pdf(paste("~/Desktop/ResearchProjects/LiverCancerProject/DEA_removed_samples/newFigures/x_degenerate_tumor_gene_expression/",gene,"_tumor_expression_500Axis_data.pdf",sep=""), width=12, height=12)
  print(ggplot(Tumor_expressionData,aes(x=reorder(Names,SexViralNumeric),y= Expression,fill=SexViralNumeric)) + geom_bar(stat="identity", colour="black") +theme(axis.text.x = element_text(angle = 90, vjust = 0.75,hjust = 0.75, size=8)) +  scale_x_discrete(guide = guide_axis(n.dodge = 2))+ coord_cartesian(ylim=c(0,500))+xlab("Tumor Samples Expression data") + labs(title=paste(gene,"Tumor Samples Expression Data")))
  dev.off() 
  
  #Creates a box plot of x degenerate gene expression data of all tumor adjacent samples
  pdf(paste("~/Desktop/ResearchProjects/LiverCancerProject/DEA_removed_samples/newFigures/x_degenerate_adjacent_gene_expression/",gene,"_tumor_adjacent_expression_data.pdf",sep=""), width=12, height=12)
  ...
  pdf(paste("~/Desktop/ResearchProjects/LiverCancerProject/DEA_removed_samples/newFigures/x_degenerate_adjacent_gene_expression/",gene,"_tumor_adjacent_expression_500Axis_data.pdf",sep=""), width=12, height=12)
  print(ggplot(Adjacent_expressionData,aes(x=reorder(Names,SexViralNumeric),y= Expression,fill=SexViralNumeric)) + geom_bar(stat="identity", colour="black") +theme(axis.text.x = element_text(angle = 90, vjust = 0.75,hjust = 0.75, size=8)) +  scale_x_discrete(guide = guide_axis(n.dodge = 2))+ coord_cartesian(ylim=c(0,500))+xlab("Adjacent Samples Expression data") + labs(title=paste(gene,"Tumor Adjacent Samples Expression Data")))
  dev.off() 
