...
#chisq.test(AlcoholIntake, simulate.p.value = TRUE, B = 10000)
# reject null hypothesis
```
```{r alcohol total counts}
...
AlcoholHist<- data.frame(Males= c(Male0,Male1,Male2,Male3), Females= c(Female0, Female1, Female2,Female3))
...
CONCLUSION: We are 95 percent confident that the proportion of males and females with each tumor stage is the same.
...
EdmonsonGrade<- data.frame(Males= c(MaleEg0,MaleEg1,MaleEg1.5,MaleEg2,MaleEg2.5,MaleEg3,MaleEg4), Females= c(FemaleEg0,FemaleEg1, FemaleEg1.5, FemaleEg2,FemaleEg2.5,FemaleEg3,FemaleEg4))
rownames(EdmonsonGrade)<- c(0,1,1.5,2,2.5,3,4)

chisq.test(EdmonsonGrade)
chisq.test(EdmonsonGrade, simulate.p.value = TRUE, B = 10000)
```
