...
design <- model.matrix(~0+v$targets$viral+v$targets$library_type+v$targets$Ta + v$targets$sex)
...
pdf("~/Desktop/Research Projects/Liver Cancer Project/Figures/etiology tumor tumor adjacent final model.pdf", width=12, height=12)
plotSA(veBayesFit, main = "Final model: Mean-variance trend")
dev.off()

DEGs_HBV <- topTable(veBayesFit, coef=1, n=Inf, p.value=0.05, lfc=2)
write.csv(DEGs_HBV, "~/Desktop/Research Projects/Liver Cancer Project/Gene lists/DEG_HBV_covariate.csv")

DEGs_HCV <- topTable(veBayesFit, coef=2, n=Inf, p.value=0.05, lfc=2)
write.csv(DEGs_HCV, "~/Desktop/Research Projects/Liver Cancer Project/Gene lists/DEG_HCV_covariate.csv")
```
...
pdf("~/Desktop/Research Projects/Liver Cancer Project/Figures/Volcanoplots/Volcano_plot_HBV.pdf", width=12, height=12)
p4
dev.off()
```
